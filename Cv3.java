...
public class Cv3 {
	public static void main(String args[]) throws IOException, InterruptedException
	{
		...
		for (i=0;i<Datav2.NUM_UNIQUE_CHARACTERS;i++)
		{
			...
			if(requestedServerAddress==Datav2.SERVER1_ADDRESS){s1avg=Datav2.BETA*s1avg+(1-Datav2.BETA)*delayTemp;System.out.println("1");}
			else if(requestedServerAddress==Datav2.SERVER2_ADDRESS){s2avg=Datav2.BETA*s2avg+(1-Datav2.BETA)*delayTemp;System.out.println("2");}
			else if(requestedServerAddress==Datav2.SERVER3_ADDRESS){s3avg=Datav2.BETA*s3avg+(1-Datav2.BETA)*delayTemp;System.out.println("3");}
			else if(requestedServerAddress==Datav2.SERVER4_ADDRESS){s4avg=Datav2.BETA*s4avg+(1-Datav2.BETA)*delayTemp;System.out.println("4");}
